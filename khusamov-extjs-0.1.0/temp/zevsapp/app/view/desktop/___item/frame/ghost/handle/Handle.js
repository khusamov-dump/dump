...
Ext.define("Zevs.view.desktop.item.frame.ghost.handle.Handle", {
	...
	onCircleClick: function(e, t, eOpts) {
		...
		// TODO исправить когда будет возможность
		//http://javascript.ru/forum/extjs/55945-dostup-k-komponentu-iz-obrabotchika-sobytiya-ego-html-ehlementa.html
		/*
			...
			http://docs.sencha.com/extjs/5.1/5.1.1-apidocs/#!/api/Ext.mixin.Observable-method-addListener
		*/
		
		
		var circle = t._circle;
