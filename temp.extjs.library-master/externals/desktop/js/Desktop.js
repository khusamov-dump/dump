...
Ext.define('Ext.ux.desktop.Desktop', {
    ...
    initComponent: function () {
        ...
        // Если выставить me.bbar, то таскбар будет снизу
    ...
    createWindowMenu: function () {
        ...
        return {
            ...
            items: [{ 
            	...
            	handler: me.onWindowMenuRestore, scope: me 
            }, { 
            	text: 'Свернуть', 
            	iconCls: "icon-application-put",
            	handler: me.onWindowMenuMinimize, scope: me 
            }, { 
            	text: 'Развернуть', 
            	iconCls: "icon-application",
            	handler: me.onWindowMenuMaximize, scope: me 
            }, '-', { 
            	text: 'Закрыть', 
            	iconCls: "icon-application-delete",
            	handler: me.onWindowMenuClose, scope: me 
            }],
            listeners: {
    ...
    createWindow: function(config, cls) {
        ...
        win.animateTarget = win.taskButton.el; // Анимация сворачивания окна
